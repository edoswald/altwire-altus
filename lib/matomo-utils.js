...
export function normalizeTopArticles(rawArticles, baseUrl) {
  ...
  const JUNK_PATH_PATTERNS = [
    /^[a-z]{2}$/,              // 2-letter language codes: ru, es, de, fr, en
    /^\/?(tag|author|category|reviews|news|index|board-review|wp-content|video|page)\/?/i,
    /^\d{4}(\/|$)/,            // year archive pages: 2017/, 2024/, etc.
    /^\/?$/,                   // root
  ];
